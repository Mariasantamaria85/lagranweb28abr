...
let fondoizq = document.getElementsByClassName('fondoizq');
let fondoderecha = document.getElementsByClassName('fondoderecha');
...
document.querySelector('.parallax').addEventListener('mousemove', function(e) {
  ...
  fondoderecha.style.transform = 'translate(' + offsetX * 0.9 + 'px, ' + offsetY * 1 + 'px)';
  fondoizq.style.transform = 'translate(' + offsetX * 0.9 + 'px, ' + offsetY * 1 + 'px)';
});
